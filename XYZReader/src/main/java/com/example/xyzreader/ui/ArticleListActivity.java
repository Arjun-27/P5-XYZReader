...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refresh_anim = AnimationUtils.loadAnimation(getApplication(), R.anim.refresh_rotate_anim);
    ...
    private void updateRefreshingUI() {
        if(mIsRefreshing) {
            ...
            fab_refresh.startAnimation(refresh_anim);
        }
        else
            refresh_anim.setRepeatCount(0);
